/*
 * Live2D Widget
 * https://github.com/veehz/live2d-widget
 * Original: https://github.com/stevenjoezhang/live2d-widget
 */
function loadWidget(config) {
  ...
  let userAction = false,
    ...
    // messageArray in English
    messageArray = [
      "How long have you been away? It's been so fast!",
      "Hey! You're still here?",
      "Hey~ Come on, let's play together!",
      "I'm bored. Come on, let's play together!",
      "*wink*",
      "*hits* you!",
      "Remember to add me to Adblock whitelist!",
    ];
  ...
  (function registerEventListener() {
    ...
    document
      ...
      .addEventListener("click", () => {
        ...
        showMessage("It's done! Do you like it?", 6000, 9);
    ...
    document
      ...
      .addEventListener("click", () => {
        ...
        showMessage("I hope you meet someone special one day.", 2000, 11);
    ...
    devtools.toString = () => {
      ...
      showMessage(
        "Hehe, you opened the console, do you want to see my secret?",
        6000,
        9
      );
    };
    window.addEventListener("copy", () => {
      ...
      showMessage("You copied somehting, be sure to credit me!", 6000, 9);
    });
    window.addEventListener("visibilitychange", () => {
      if (!document.hidden) {
        // showMessage("哇，你终于回来了～", 6000, 9);
        showMessage("Whew, you're back!", 6000, 9);
      }
    });
  })();
  (function welcomeMessage() {
    ...
    if (location.pathname === "/") {
      ...
      if (now > 5 && now <= 7)
        ...
        text = "Good morning! A new day is about to begin.";
        ...
        text = "It's afternoon, are you done with your workout?";
      else if (now > 17 && now <= 19)
        // text = "傍晚了！窗外夕阳的景色很美丽呢，最美不过夕阳红～";
        text = "It's evening, the sky is beautiful!";
      else if (now > 19 && now <= 21)
        // text = "晚上好，今天过得怎么样？";
        text = "Good evening, how are you today?";
      else if (now > 21 && now <= 23)
        // text = ["已经这么晚了呀，早点休息吧，晚安～", "深夜时要爱护眼睛呀！"];
        text = ["It's late, time to sleep!", "Good night, good sleep!"];
      // text = "你是夜猫子呀？这么晚还不睡觉，明天起的来嘛？";
      else text = "It's late! Can you wake up early tomorrow?";
      ...
      if (location.hostname === referrer.hostname)
        ...
        text = `Hello friends from baidu! Did you find me looking for <span>${
          referrer.search.split("&wd=")[1].split("&")[0]
        }</span>?`;
      /* else if (domain === "so")
			text = `Hello！来自 360搜索 的朋友<br>你是搜索 <span>${
			  referrer.search.split("&q=")[1].split("&")[0]
			}</span> 找到的我吗？`; */ else if (domain === "google")
        /* text = `Hello！来自 谷歌搜索 的朋友<br>欢迎阅读<span>「${
			  document.title.split(" - ")[0]
			}」</span>`; */
        text = `Hello friends from google! Welcome to <span>「${
          document.title.split(" - ")[0]
        }」</span>`;
  ...
  //       showMessage("How do you like my new clothes?", 4000, 10);
  //     } else {
  ...
  //             showMessage("I don't have any other clothes!", 4000, 10);
  //           else
  //             loadModel(
  //               modelId,
  //               result.textures.id,
  //               /* "我的新衣服好看嘛？" */ "How do you like my new clothes?"
  //             );
  //         });
  //     }
  //   }
